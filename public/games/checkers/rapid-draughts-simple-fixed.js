...
(function() {
    ...
    class EnglishDraughts {
        ...
        generateMoves() {
            ...
            console.log('🔍 Gerando movimentos para jogador:', player);
            console.log('🔍 Board atual:', board);
            ...
            console.log('🔍 Movimentos gerados:', moves.length);
            return moves;
        }
        ...
        move(move) {
            ...
            console.log('🎯 Executando movimento:', move);
            ...
            console.log('✅ Movimento executado, novo jogador:', newPlayer);
        }
    ...
    const EnglishDraughtsComputerFactory = {
        ...
        alphaBeta: function(options = {}) {
            ...
            return async function(game) {
                ...
                const moves = game.moves;
                console.log('🤖 Movimentos disponíveis:', moves.length);

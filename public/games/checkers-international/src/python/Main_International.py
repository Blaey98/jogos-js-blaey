# The driver program for International Checkers
# Uses international rules: backward capture and free king movement
# Based on the original checkers engine by Collin Kees
